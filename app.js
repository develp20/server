...
app.use("./content/videos", express.static(path.join(__dirname, "videos")))
app.use("./content/thumbnails", express.static(path.join(__dirname, "thumbnails")))
...
// let FL_VIDEO_PATH = "./videos/";
// let FL_THUMB_PATH = "./thumbnails/"
    ...
    admin: {
        ...
        posts: {
            get: {
                ...
                popular: function(clientID, fromClientID, callback) {
                    db.posts.find({
                        $and: [
                            {
                                "info.postedAt": {
                                    $gt: Date.now() - (86400000 * 3)
                                }
                            },
                            {
                                "info.postedBy": {
...
let apiPrefix = "/api/v3"

app.post(apiPrefix + "/user/forgot/password/request", (req, res) => {
...
app.post(apiPrefix + "/user/login", (req, res) => {
	let email = req.body.email;
...
app.post(apiPrefix + "/user/twitter/login", (req, res) => {
...
app.post(apiPrefix + "/user/signup", (req, res) => {
...
app.post(apiPrefix + "/user/username/update", (req, res) => {
...
app.post(apiPrefix + "/user/email/update", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/user/auth", (req, res) => {
...
app.post(apiPrefix + "/user/logout", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/profile/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/settings/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/services/:name/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/service/connect", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/service/disconnect", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/relationships/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/relationship/create", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/block/create", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/block/destroy", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/relationship/destroy", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/settings/update", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/setting/update", (req, res) => {
    let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/users/search/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/notifications/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/bookmark/create", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/bookmark/destroy", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/bookmarks/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.get(apiPrefix + "/post/stream/:vID", (req, res) => {
...
app.get(apiPrefix + "/post/thumb/:tID", (req, res) => {
...
app.post(apiPrefix + "/post/view", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/upload", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/destroy", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/caption/update", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/posts/hashtag/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/like/create", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/like/destroy", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/likes/get", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/comments/get", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/comment/create", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/post/comment/destroy", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/user/feed/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/posts/explore/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/onboarding/posts/get", (req, res) => {
...
app.post(apiPrefix + "/user/posts/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/report/create", (req, res) => {
	let clientID = req.body.clientID;
	let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/report/types/get", (req, res) => {
	var reportReasons = {
		"post": [
			{
				id: 0,
...
app.post(apiPrefix + "/admin/login", (req, res) => {
    let email = req.body.email;
...
app.post(apiPrefix + "/admin/users/get", (req, res) => {
    let clientID = req.cookies.clientID;
	let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/posts/get", (req, res) => {
    let clientID = req.cookies.clientID;
	let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/get", (req, res) => {
    let clientID = req.cookies.clientID;
	let sessionID = req.cookies.sessionID;
	...
	flip.admin.auth(req.cookies, function(auth) {
		if(auth.response == "OK") {
            flip.explore.get(clientID, 0, true, function(data0) {
                if(data0.response == "OK") {
                    flip.admin.posts.get.popular(clientID, clientID, function(data1) {
                        if(data1.response == "OK") {
                            res.send({
                                response: "OK",
                                data: {
...
app.post(apiPrefix + "/admin/explore/feed/create", (req, res) => {
    let clientID = req.cookies.clientID;
	let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/card/info/create", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/card/delete", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/card/user/create", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/card/splitter/create", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/card/splitter/delete", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/rearrange", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.post(apiPrefix + "/admin/explore/post/create", (req, res) => {
    let clientID = req.cookies.clientID;
    let sessionID = req.cookies.sessionID;
...
app.get(apiPrefix + "/watch/:postID", (req, res) => {
...
app.post(apiPrefix + "/chat/thread/message/destroy", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/chat/thread/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
...
app.post(apiPrefix + "/chat/threads/get", (req, res) => {
    let clientID = req.body.clientID;
    let sessionID = req.body.sessionID;
